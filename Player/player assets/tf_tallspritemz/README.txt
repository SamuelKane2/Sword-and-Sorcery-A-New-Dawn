Tall size characters for 'RPG Maker MZ'.

This is a remake of the walking graphics of the characters in the img/characters folder, which is one of the official materials of 'RPG Maker MZ' (©Gotcha Gotcha Games Inc./YOJI OJIMA 2020).
...
https://forums.rpgmakerweb.com/index.php?threads/126160/
 ...
 * You can use this software only if you have the official license of the RPG Maker series.
 * You may not use it for any other purpose than the RPG Maker series.

You may not redistribute this material as-is.
 Instead, please provide the URL of the distribution site ( http://tonbi.jp/ or http://tonbi.jp/Game/RPGMakerMZ/ or https://forums.rpgmakerweb.com/index.php?threads/126160/).
 ...
 * Please also write the URL of the distribution site of this material ( http://tonbi.jp/ or http://tonbi.jp/Game/RPGMakerMZ/ or https://forums.rpgmakerweb.com/index.php?threads/126160/ ).
 * Please specify that it is a modified version of this material.
 * The copyright of 'RPG Maker MZ' (©Gotcha Gotcha Games Inc./YOJI OJIMA 2020) is required.

Example of notation in case of modification based on this material.
This material is a modified version of the Tall size characters for 'RPG Maker MZ' created by Tonbi@Tobishima-Factory (tonbi.jp).

----
©Tonbi@Tobishima-Factory 2020-2023
